...
import CustomViewport from "./molecures/CustomViewport";
import GridTemplate from "./molecures/GridTemplate";
...
const ListVirtualization = () => {
  ...
  return (
    <div css={{ display: "flex" }}>
      <p css={{ marginRight: "50px" }}>navigation</p>
      <CustomViewport
      ...
      >
        <Header
          ref={headerRef}
          contentCopmonent={
            <div css={{ height: "100px", border: "1px solid green" }}>
              header
            </div>
          }
        />
        <GridTemplate
          ...
          itemComponent={({ id, url, thumbnailUrl }) => {
            return (
              <>
                <div css={itemWrapper}>
